...
#define GPIO_PB10_RCC_CLK_ENABLE()      __HAL_RCC_GPIOB_CLK_ENABLE()  //wt.edit
#define GPIO_PB10_PIN                   GPIO_PIN_10
#define GPIO_PB10                       GPIOB

#define GPIO_PB10_HIGH                   HAL_GPIO_WritePin(GPIO_PB10,GPIO_PB10_PIN ,GPIO_PIN_SET)    // 输出高电平
#define GPIO_PB10_LOW                    HAL_GPIO_WritePin(GPIO_PB10,GPIO_PB10_PIN ,GPIO_PIN_RESET)  // 输出低电平
