...
__IO uint8_t I2C_TX_Pulse_data=0;  //时时读取脉冲数
...
int main(void)
{
 ...
 // float ftemp;
  ...
  memcpy(txbuf,"This SPI_Slave code of version 7.07 \n",100);
  ...
  while (1)
  {
	  ...
	  if(KEY1_StateRead()==KEY_DOWN)
		...
		if(I2C_TX_Pulse_data==1)
		{
           I2C_TX_Pulse_data=0;
		   switch(A2_ReadPulse) //if(A2_ReadPulse==1) //wt.edit 2018.04.12
		   	{
              case 1:
